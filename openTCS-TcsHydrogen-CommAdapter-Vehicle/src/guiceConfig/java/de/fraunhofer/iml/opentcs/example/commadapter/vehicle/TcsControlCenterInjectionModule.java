...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.exchange.TcsCommAdapterPanelFactory;
 ...
 */
public class TcsControlCenterInjectionModule
  ...
  protected void configure() {
    ...
    commAdapterPanelFactoryBinder().addBinding().to(TcsCommAdapterPanelFactory.class);
  }
}
