...
public class TcsCommAdapter
   ...
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(TcsCommAdapter.class);
  /**
   ...
   */
  @Inject
  public TcsCommAdapter(@Assisted Vehicle vehicle,
                            OrderMapper orderMapper,
                            TcsAdapterComponentsFactory componentsFactory,
  ...
  public void propertyChange(PropertyChangeEvent evt) {
    ...
    if (!(evt.getSource() instanceof TcsProcessModel)) {
      return;
    }
