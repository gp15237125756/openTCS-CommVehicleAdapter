...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.exchange.TcsCommAdapterDescription;
...
public class TcsCommAdapterFactory
    implements VehicleCommAdapterFactory {

  /**
   * This class's Logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(TcsCommAdapterFactory.class);

  /**
   * The factory to create components specific to the comm adapter.
   */
  private final TcsAdapterComponentsFactory componentsFactory;
  /**
   ...
   */
  @Inject
  public TcsCommAdapterFactory(TcsAdapterComponentsFactory componentsFactory) {
  ...
  public VehicleCommAdapterDescription getDescription() {
    return new TcsCommAdapterDescription();
  }
  ...
  public VehicleCommAdapter getAdapterFor(Vehicle vehicle) {
    ...
    TcsCommAdapter adapter = componentsFactory.createTcsCommAdapter(vehicle);
