...
/**
 * A custom model for the {@link TcsCommAdapter} which holds additional information
 * about the connected vehicle.
 *
 * @author Mats Wilhelm (Fraunhofer IML)
 */
public class TcsProcessModel
   ...
   */
  public TcsProcessModel(Vehicle attachedVehicle) {
