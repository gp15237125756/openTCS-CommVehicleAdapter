 ...
 */
public class TcsCommAdapterPanelFactory
    implements VehicleCommAdapterPanelFactory {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(TcsCommAdapterPanelFactory.class);
  /**
   * The service portal.
   */
   ...
   */
  @Inject
  public TcsCommAdapterPanelFactory(KernelServicePortal servicePortal,
  ...
  public List<VehicleCommAdapterPanel> getPanelsFor(
    ...
    panels.add(componentsFactory.createControlPanel((TcsProcessModelTO) processModel,
                                                    servicePortal.getVehicleService()));
    panels.add(componentsFactory.createStatusPanel((TcsProcessModelTO) processModel,
                                                   servicePortal.getVehicleService()));
    return panels;
  }
  ...
  private boolean providesPanelsFor(VehicleCommAdapterDescription description,
    ...
    return (description instanceof TcsCommAdapterDescription)
        && (processModel instanceof TcsProcessModelTO);
  }
}
