...
/**
 * A serializable representation of a {@link TcsProcessModel}.
 ...
 */
public class TcsProcessModelTO
   ...
   * @return This
   */
  public TcsProcessModelTO setVehicleRef(TCSObjectReference<Vehicle> vehicleRef) {
   ...
   * @return This
   */
  public TcsProcessModelTO setCurrentState(
   ...
   * @return This
   */
  public TcsProcessModelTO setPreviousState(
   ...
   * @return This
   */
  public TcsProcessModelTO setLastOrderSent(
   ...
   * @return This
   */
  public TcsProcessModelTO setVehicleHost(String vehicleHost) {
   ...
   * @return This
   */
  public TcsProcessModelTO setVehiclePort(int vehiclePort) {
   ...
   * @return This
   */
  public TcsProcessModelTO setPeriodicStateRequestEnabled(boolean periodicStateRequestEnabled) {
   ...
   * @return This
   */
  public TcsProcessModelTO setStateRequestInterval(int stateRequestInterval) {
   ...
   * @return This
   */
  public TcsProcessModelTO setVehicleIdleTimeout(int vehicleIdleTimeout) {
   ...
   * @return This
   */
  public TcsProcessModelTO setVehicleIdle(boolean vehicleIdle) {
   ...
   * @return This
   */
  public TcsProcessModelTO setDisconnectingOnVehicleIdle(boolean disconnectingOnVehicleIdle) {
   ...
   * @return This
   */
  public TcsProcessModelTO setReconnectingOnConnectionLoss(boolean reconnectingOnConnectionLoss) {
   ...
   * @return This
   */
  public TcsProcessModelTO setReconnectDelay(int reconnectDelay) {
   ...
   * @return This
   */
  public TcsProcessModelTO setLoggingEnabled(boolean loggingEnabled) {
