 ...
 */
public class TcsCommAdapterFactoryTest {

  private TcsCommAdapterFactory commAdapterFactory;

  @Before
  public void setUp() {
    commAdapterFactory = new TcsCommAdapterFactory(mock(TcsAdapterComponentsFactory.class));
  }
